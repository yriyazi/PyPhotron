...
unsigned long WINAPI PDC_GetMediaAcceleration(unsigned long nDeviceNo,
	unsigned long nSlotNo,
	unsigned long nDataNo,
	long nFrameNo,
	PVOID pData,
...
unsigned long WINAPI PDC_SetLowLightMode2(
	...
	unsigned long nMode,
	unsigned long *pErrorCode);
unsigned long WINAPI PDC_GetLowLightModeEx(
	unsigned long nDeviceNo,
	unsigned long *nLowLightMode,
	unsigned long *pErrorCode);
unsigned long WINAPI PDC_SetLowLightModeEx(
	unsigned long nDeviceNo,
	unsigned long nLowLightMode,
	unsigned long *pErrorCode);
...
unsigned long WINAPI PDC_GetMediaSaveAfterInsert(
	unsigned long	nDeviceNo,
	unsigned long	*pMode,
	unsigned long	*pErrorCode
	);

unsigned long WINAPI PDC_SetMediaSaveAfterInsert(
	unsigned long	nDeviceNo,
	unsigned long	nMode,
	unsigned long	*pErrorCode
	);
...
unsigned long WINAPI PDC_GetDeviceErrorList(
	unsigned long	nDeviceNo,
	unsigned long	nChildNo,
	unsigned long	*pSize,
	unsigned long	*pList,
...
unsigned long WINAPI PDC_GetDeviceErrorObserve(
	unsigned long nDeviceNo,
	unsigned long *pMode,
	unsigned long *pErrorCode
	);

unsigned long WINAPI PDC_SetDeviceErrorObserve(
	unsigned long nDeviceNo,
	unsigned long nMode,
	unsigned long *pErrorCode
	);
...
unsigned long WINAPI PDC_GetCameraHeadType(
	unsigned long nDeviceNo,
	unsigned long nChildNo,
	unsigned long *pType,
	unsigned long *pErrorCode);

unsigned long WINAPI PDC_GetHeadPortNumber(
	unsigned long nDeviceNo,
	unsigned long nChildNo,
...
unsigned long WINAPI PDC_GetLinkSpeed(
	unsigned long nDeviceNo,
	unsigned long *pLinkSpeed,
	unsigned long *pErrorCode);

unsigned long WINAPI PDC_GetPacketIntervalMode(
	unsigned long nDeviceNo,
	unsigned long nLinkSpeed,
	unsigned long *pMode,
	unsigned long *pErrorCode);

unsigned long WINAPI PDC_SetPacketIntervalMode(
	unsigned long nDeviceNo,
	unsigned long nLinkSpeed,
	unsigned long nMode,
	unsigned long *pErrorCode);

unsigned long WINAPI PDC_GetEthernetSpeedLimit(
	unsigned long nDeviceNo,
	unsigned long *pParam,
	unsigned long *pErrorCode);

unsigned long WINAPI PDC_SetCommunicationParameter(
	unsigned long nInterfaceCode,
	unsigned long nParamKey,
	unsigned long nParamValue,
	unsigned long *pErrorCode);

unsigned long WINAPI PDC_GetCommunicationParameter(
	unsigned long nInterfaceCode,
	unsigned long nParamKey,
...
unsigned long WINAPI PCFC_GetAccelerationData(unsigned long nDataNo, long nFrameNo, PPDC_ACCELERATION_DATA pAcceleration, unsigned long *pErrorCode);
...
unsigned long WINAPI PDC_InitCihxSave(
	PDC_ARCHIVE_HANDLE* pHandle,
	unsigned long*		pErrorCode
	);

unsigned long WINAPI PDC_ExitCihxSave(
	PDC_ARCHIVE_HANDLE	handle,
	unsigned long*		pErrorCode
	);

unsigned long WINAPI PDC_CancelCihxSave(
    PDC_ARCHIVE_HANDLE	handle,
    unsigned long*		pErrorCode
    );

unsigned long WINAPI PDC_GetCihxSaveStatusA(
    PDC_ARCHIVE_HANDLE		handle,
...
unsigned long WINAPI PDC_GetCihxSaveStatusW(
    PDC_ARCHIVE_HANDLE		handle,
    PDC_ARCHIVE_DATA_TYPE*	pDataType,
    PDC_EXPORT_STATUS*		pStatus,
    unsigned long*			pProgress,
...
unsigned long WINAPI PDC_SaveCihxFromCameraA(
	PDC_ARCHIVE_HANDLE		handle,
	const char*				pPath,
	unsigned long			nDeviceNo,
	unsigned long			nChildNo,
...
unsigned long WINAPI PDC_SaveCihxFromCameraW(
    PDC_ARCHIVE_HANDLE		handle,
    const wchar_t*			pPath,
    unsigned long			nDeviceNo,
    unsigned long			nChildNo,
...
unsigned long WINAPI PDC_SaveCihxFromCameraForStorageA(
    PDC_ARCHIVE_HANDLE		handle,
    const char*				pPath,
    unsigned long			nDeviceNo,
    unsigned long			nChildNo,
...
unsigned long WINAPI PDC_SaveCihxFromCameraForStorageW(
    PDC_ARCHIVE_HANDLE		handle,
    const wchar_t*			pPath,
    unsigned long			nDeviceNo,
    unsigned long			nChildNo,
...
unsigned long WINAPI PDC_SaveCihxFromCameraStorageA(
	PDC_ARCHIVE_HANDLE		handle,
	const char*				pPath,
...
unsigned long WINAPI PDC_SaveCihxFromCameraStorageW(
    PDC_ARCHIVE_HANDLE		handle,
    const wchar_t*			pPath,
    PDC_SOURCE_STORAGE_TYPE storageType,
    unsigned long			nDeviceNo,
...
unsigned long WINAPI PDC_SaveCihxFromExternalStorageA(
	PDC_ARCHIVE_HANDLE		handle,
	const char*				pPath,
	PDC_SOURCE_STORAGE_TYPE storageType,
...
unsigned long WINAPI PDC_SaveCihxFromExternalStorageW(
    PDC_ARCHIVE_HANDLE		handle,
    const wchar_t*			pPath,
    PDC_SOURCE_STORAGE_TYPE storageType,
    unsigned long			nDriveNo,
...
unsigned long WINAPI PDC_SaveCihxFromFileA(
	PDC_ARCHIVE_HANDLE		handle,
	const char*				pSource,
	const char*				pPath,
    PPDC_ARCHIVE_PARAM      pRequired,
...
unsigned long WINAPI PDC_SaveCihxFromFileW(
    PDC_ARCHIVE_HANDLE		handle,
...
unsigned long WINAPI PDC_SaveCihxFromXmlA(
	PDC_ARCHIVE_HANDLE		handle,
	const char*				pSource,
	const char*				pPath,
    PPDC_ARCHIVE_PARAM      pRequired,
...
unsigned long WINAPI PDC_SaveCihxFromXmlW(
    PDC_ARCHIVE_HANDLE		handle,
    const char* 			pSource,
    const wchar_t*			pPath,
    PPDC_ARCHIVE_PARAM      pRequired,
...
unsigned long WINAPI PDC_GetCihxValueA(
    const char*		pPath,
    const char*		pKey,
	char*			pValue,
	unsigned long*	pErrorCode
...
unsigned long WINAPI PDC_GetCihxValueW(
    const wchar_t*	pPath,
    const wchar_t*	pKey,
    wchar_t*		pValue,
    unsigned long*	pErrorCode
...
unsigned long WINAPI PDC_GetCihxDataTypesA(
    const char*				pPath,
...
unsigned long WINAPI PDC_GetCihxDataTypesW(
    const wchar_t*			pPath,
    PPDC_ARCHIVE_DATA_HEAD	pDataTypes,
    unsigned long*			pCount,
    unsigned long*			pErrorCode
...
unsigned long WINAPI PDC_GetCihxDataA(
    const char*				pPath,
...
unsigned long WINAPI PDC_GetCihxDataW(
    const wchar_t*			pPath,
    PDC_ARCHIVE_DATA_TYPE	dataType,
    char*					pData,
    unsigned long*			pErrorCode
